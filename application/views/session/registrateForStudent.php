...
<?php endif; ?>
<form class="form-registrate" name="register_for_student" action="<?php echo URL::base() ?>student-registration" method="POST" enctype="multipart/form-data">
    ...
    <fieldset style="margin-top: 10px">
        ...
        <div class="tels">
            <div class="group-field-block tel">
                ...
                <input type="text" name="tels_em[0][name]" class="tels_em_name" id="tels_em_0_name" value="<?php echo Helper_Main::getPostValue('tels_em.0.name') ?>">
                <label for="tels_em_0_tel">Tel. No.</label>
                <input type="text" name="tels_em[0][tel]" class="tels_em_tel" id="tels_em_0_tel" value="<?php echo Helper_Main::getPostValue('tels_em.0.tel') ?>">
            </div>
        </div>
