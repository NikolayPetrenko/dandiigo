...
<?php endif; ?>
<form class="form-registrate" name="achievement_teacher_record_edit" action="<?php echo URL::base() ?>achievement-teacher-records/edit/<?php echo $record->id ?>/<?php echo $teacher->teacher_id ?>/<?php echo $year ?>" method="POST">
    <fieldset>
