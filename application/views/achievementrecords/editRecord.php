...
<?php endif; ?>
<form class="form-registrate" name="achievement_record_edit" action="<?php echo URL::base() ?>achievement-records/edit/<?php echo $record->id ?>/<?php echo $student->student_id ?>/<?php echo $year ?>" method="POST">
    <fieldset>
